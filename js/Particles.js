...
function particleFX(x, y, num, color, optionalVelX, optionalVelY, optionalLifespan, optionalGravity, optionalVelocityRandomness, optionalXYRandomness)
{
    ...
    for (var i = 0; i < num; i++) {
        ...
        if (optionalXYRandomness)
        {
            x = x + (Math.random() * optionalXYRandomness - (optionalXYRandomness/2));    
            y = y + (Math.random() * optionalXYRandomness - (optionalXYRandomness/2));    
        }
...
// convert x,y, to isometric first
function particleFXiso(x, y, num, color, optionalVelX, optionalVelY, optionalLifespan, optionalGravity, optionalVelocityRandomness, optionalXYRandomness)
{
    var iso = twoDToIso(x, y);
    particleFX(iso.x, iso.y, num, color, optionalVelX, optionalVelY, optionalLifespan, optionalGravity, optionalVelocityRandomness, optionalXYRandomness)
}